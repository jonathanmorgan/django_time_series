...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BasicTimeSeriesData'
        db.create_table(u'django_time_series_basictimeseriesdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'django_time_series', ['BasicTimeSeriesData'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'BasicTimeSeriesData'
        db.delete_table(u'django_time_series_basictimeseriesdata')


    models = {
        u'django_time_series.basictimeseriesdata': {
            'Meta': {'object_name': 'BasicTimeSeriesData'},
